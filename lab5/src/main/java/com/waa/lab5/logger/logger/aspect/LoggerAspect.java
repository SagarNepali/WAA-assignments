package com.waa.lab5.logger.logger.aspect;

import com.waa.lab5.logger.logger.domain.Logger;
import com.waa.lab5.logger.logger.service.LoggerService;
...
public class LoggerAspect {
    ...
    @Pointcut("@annotation(com.waa.lab5.logger.logger.aspect.annotation.ExecutionTime)")
    public void logExecutionTime(){}

    @Pointcut("execution(* com.waa.lab5.comment.service.CommentServiceImpl.*())")
    public void logCommentService(){}

    @Pointcut("execution(* com.waa.lab5.user.service.UserServiceImpl.*())")
    public void logUserService(){}

    @Pointcut("execution(* com.waa.lab5.post.service.PostServiceImpl.*())")
