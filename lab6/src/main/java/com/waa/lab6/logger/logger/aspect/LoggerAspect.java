package com.waa.lab6.logger.logger.aspect;

import com.waa.lab6.logger.logger.domain.Logger;
import com.waa.lab6.logger.logger.service.LoggerService;
...
public class LoggerAspect {
    ...
    @Pointcut("@annotation(com.waa.lab6.logger.logger.aspect.annotation.ExecutionTime)")
    public void logExecutionTime(){}

    @Pointcut("execution(* com.waa.lab6.comment.service.CommentServiceImpl.*())")
    public void logCommentService(){}

    @Pointcut("execution(* com.waa.lab6.user.service.UserServiceImpl.*())")
    public void logUserService(){}

    @Pointcut("execution(* com.waa.lab6.post.service.PostServiceImpl.*())")
